import { getSubscribers } from "@/features/newsletter/queries";
...
export default async function NewslettersPage(props: {
  ...
  const { data: subscribers, totalItems } = await getSubscribers(page, search);
